...
const generateUrlsStep2 = async (infoUrls) => {
    ...
    try {
        ...
        for await (const response of promises) {
            ...
            const aEle = doc.querySelector("#results > ul > li.item.first > figure > div > a");
...
export const generateUrls = async (id,  pageStart, pageEnd) => {
    try {
        ...
        const elements = doc.querySelectorAll("#resources > div.additional-resources > div.resource > figure > div > a");
...
export const generateUrlsDpi = async (id,  pageStart, pageEnd) => {
    try {
        ...
        const elements = doc.querySelectorAll("#resources > div.additional-resources > div.resource.selected > figure > div > a");
